...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fafa;padding:24px 0;">
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
      ...
      {{-- Orange accent banner for staff --}}
      <tr><td style="background:#F7941D;padding:24px 32px;">
        <p style="margin:0;font-size:11px;color:#fff;letter-spacing:.08em;text-transform:uppercase;font-weight:600;">Focus — Staff Notification</p>
        <h1 style="margin:6px 0 4px;font-size:22px;color:#fff;font-weight:700;">Engagement Letter Signed</h1>
      </td></tr>
      ...
      <tr><td style="padding:28px 32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-radius:6px;margin:0 0 24px;border:1px solid #c8eeec;">
          <tr><td style="padding:16px 20px;background:#f0fafa;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:4px 0;font-size:13px;color:#888;width:120px;">Client</td>
                <td style="padding:4px 0;font-size:13px;font-weight:600;">{{ $letter->client->company_name }}</td>
              </tr>
              <tr>
                <td style="padding:4px 0;font-size:13px;color:#888;">Signed by</td>
              ...
              @if($letter->renewal)
              <tr>
                <td style="padding:4px 0;font-size:13px;color:#888;">Renewal</td>
        ...
        <a href="{{ route('engagement-letters.show', $letter) }}"
           style="display:inline-block;background:#3DBFB8;color:#fff;text-decoration:none;padding:12px 28px;border-radius:6px;font-size:14px;font-weight:600;">
          View in Focus
        </a>
      </td></tr>
      ...
      <tr><td style="padding:14px 32px;border-top:1px solid #e2e8f0;background:#fafafa;">
        <p style="margin:0;font-size:11px;color:#aaa;text-align:center;">Woods Accounting &amp; Consulting — Focus &nbsp;·&nbsp; {{ now()->format('d F Y, H:i') }}</p>
      </td></tr>
